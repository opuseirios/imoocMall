<template>
    <div class='address'>
        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              ...
              <div class="shipping-addr-more" @click="expand" :class="{'open':limit>3}">
      ...
      <modal ref="deleteAddressModal">
        <p slot="message">您是否确认要删除此地址？</p>
        <div slot="btnGroup">
          <a href="javascript:;" class="btn btn--m" @click="delAddress">确认</a>
          <a href="javascript:;" class="btn btn--m" @click="closeAddressModal">取消</a>
        </div>
      </modal>
...
<script>
    ...
    export default {
      ...
      methods:{
        ...
        showAddressModal(){
          this.$refs.deleteAddressModal.openModal();
        },
        closeAddressModal(){
          this.$refs.deleteAddressModal.closeModal();
        },
