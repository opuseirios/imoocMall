<template>
    <div class='goodList'>
            ...
            <div class="accessory-list-wrap">
              <div class="accessory-list col-4">
                ...
                <div v-infinite-scroll="loadMore" infinite-scroll-disabled="busy" infinite-scroll-distance="30" class="load-more">
                  <img src="./../assets/loading-spinning-bubbles.svg" v-show="this.loading" alt="">
                </div>
              </div>
            </div>
          </div>
      ...
      <modal ref="unloginModal">
         <p slot="message">
           请先登录，否则无法加入到购物车中
         </p>
         <div slot="btnGroup">
           <a href="javascript:;" class="btn btn--m" @click="closeUnloginModal">关闭</a>
         </div>
      </modal>
      <modal ref="loginModal">
        ...
        <div slot="btnGroup">
          <a class="btn btn--m" href="javascript:;" @click="closeLoginModal">继续购物</a>
        ...
        addCart(productId){
          axios.post('/goods/addCart',{
            ...
            if(res.status==='0'){
              ...
              this.openUnloginModal();
            }
          })
        },
        closeUnloginModal(){
          this.$refs.unloginModal.closeModal();
        },
        openUnloginModal(){
          this.$refs.unloginModal.openModal();
        },
        closeLoginModal(){
